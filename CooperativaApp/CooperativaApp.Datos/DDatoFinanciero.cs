...
namespace CooperativaApp.Datos
{
    public class DDatoFinanciero
    {
        ...
        public bool Agregar(DatoFinanciero obj)
        {
            ...
            parameters[6] = new MYSQLParameter("@Seguro_Multiriesgo", obj.Seguro_Multiriesgo, MySqlDbType.Double);
            parameters[7] = new MYSQLParameter("@Estado", obj.Estado, MySqlDbType.VarChar);
        ...
        public bool Modificar(DatoFinanciero obj)
        {
            ...
            parameters[1] = new MYSQLParameter("@TEA", obj.TEA, MySqlDbType.Double);
            parameters[2] = new MYSQLParameter("@TEM", obj.TEM, MySqlDbType.Double);
            parameters[3] = new MYSQLParameter("@TED", obj.TED, MySqlDbType.Double);
            parameters[4] = new MYSQLParameter("@Seguro_Desgravamen", obj.Seguro_Desgravamen, MySqlDbType.Double);
            parameters[5] = new MYSQLParameter("@ITF", obj.ITF, MySqlDbType.Double);
            parameters[6] = new MYSQLParameter("@Otros", obj.Otros, MySqlDbType.Double);
            parameters[7] = new MYSQLParameter("@Seguro_Multiriesgo", obj.Seguro_Desgravamen, MySqlDbType.Double);
        ...
        public DatoFinanciero Seleccionar(int Codigo)
        {
            try
            {
                MYSQLParameter[] parameters = new MYSQLParameter[1];
                parameters[0] = new MYSQLParameter("@Id_Dato_Financiero_", Codigo, MySqlDbType.Int32);
                DataRow row = ConexionMySql.ExecuteProcedureData("USP_Select_Datos_Financieros", parameters).Rows[0];
                DatoFinanciero be = new DatoFinanciero
                {
                    Id_Dato_Financiero = Convert.ToInt32(row["Id_Dato_Financiero"]),
                    TEA = Convert.ToDouble(row["TEA"]),
        ...
        public DatoFinanciero Dato_Financiero_Activo()
        {
            try
            {
                ...
                DataRow row = ConexionMySql.ExecuteProcedureData("USP_ToList_Dato_Financiero_Activo").Rows[0];
                DatoFinanciero be = new DatoFinanciero
                {
                    Id_Dato_Financiero = Convert.ToInt32(row["Id_Dato_Financiero"]),
                    TEA = Convert.ToDouble(row["TEA"]),
